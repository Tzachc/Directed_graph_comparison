...
if __name__ == '__main__':
    ...
    graph.add_node(2,(4,5,6))
    graph.add_node(3,(7,8,9))
    graph.add_node(4,())
    graph.add_edge(1,2,200)
    graph.add_edge(1, 3, 57)
    graph.add_edge(2, 3, 44)
    graph.add_edge(1,4,67)
   # graph.remove_node(2)
   ...
   # graph.remove_edge(1,3)
    ...
    num, list3 = algo.shortest_path(1,2)
    print(list3)
    algo.connected_component(1)
    list1 = graph.all_out_edges_of_node(1)
    list2 = algo.connected_component(1)
    print(list2)
    check1()
    check2()
   # print(list1.keys())
  #  algo.my_dijkstra(1,2)
